...
export type StepKey = "planner" | "profile" | "product" | "credit" | "legal-precheck" | "legal" | "self-correction" | "risk" | "operations";
...
export const STEP_LABELS: Record<StepKey, string> = {
  ...
  "legal-precheck": "Legal Precheck Agent",
...
export const FAST_LANE_STEPS: StepKey[] = ["planner", "profile", "product", "credit", "operations"];
export const COMPLEX_LANE_STEPS: StepKey[] = ["planner", "profile", "product", "credit", "legal-precheck", "legal", "risk", "operations"];
...
export const deriveStepKey = (trace: AgentTrace): StepKey =>
  trace.id.startsWith("trace-planner-loop-")
    ? "self-correction"
    : trace.id.startsWith("trace-legal-precheck-")
      ? "legal-precheck"
      : (trace.agent as StepKey);
